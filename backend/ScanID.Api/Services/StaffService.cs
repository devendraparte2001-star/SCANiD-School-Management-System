            ...
            return await ExecuteWithRetryAsync(async () =>
            {
                ...
                while (await reader.ReadAsync())
                {
                    var item = new Staff
                    {
                        ...
                        PersonalContact = reader["PersonalContact"] != DBNull.Value ? reader["PersonalContact"].ToString() : null,
                ...
                try
                {
                    var sql = @"
                        EXEC dbo.sp_ManageStaff 
                            ...
                            @PersonalContact = @pPersonalContact, 
                            @EmergencyContact = @pEmergencyContact, 
                            @Status = @pStatus, 
                            @SchoolId = @pSchoolId, 
                    ...
                    var rowsAffected = await _context.Database.ExecuteSqlRawAsync(
                        ...
                        new SqlParameter("@pPersonalContact", staff.PersonalContact ?? (object)DBNull.Value),
                        new SqlParameter("@pEmergencyContact", staff.EmergencyContact ?? (object)DBNull.Value),
